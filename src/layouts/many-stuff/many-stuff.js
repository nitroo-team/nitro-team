...
function ManyStuff() {
    return (
        ...
        <DropBox name={"صفحه اصلی"} delay={.4}>
                ...
                <DropBox name={"وبلاگ"} delay={1.8}>
                    <MaybeItems>متن</MaybeItems>
                    <MaybeItems>عکس</MaybeItems>
                    <MaybeItems>پوستر</MaybeItems>
                    <MaybeItems>نظرات کاربران</MaybeItems>
                    <MaybeItems>پسندیدن متن</MaybeItems>
                </DropBox>
